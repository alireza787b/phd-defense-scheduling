...
export default function JudgePage() {
  ...
  const abstract = `در این رساله، یک سیستم هوشمند برای سنجش برخط میزان هوشیاری و خستگی خدمه پروازی با استفاده از تکنیک‌های یادگیری ماشین ارائه شده است. این سیستم با بهره‌گیری از داده‌های فیزیولوژیکی، رفتاری و عملکردی خلبانان، قادر است میزان خستگی و کاهش هوشیاری را در زمان واقعی تشخیص دهد.`;
